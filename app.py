...
def api_plot_ratio():
    ...
    # Main chart - colored by day-to-day change
    ...
    for i in range(1, len(r)):
        ...
        fig.add_trace(
            go.Scatter(
                x=x_segment, y=y_segment, mode="lines",
    ...
    while i < len(e200_cond):
        ...
        fig.add_trace(
            go.Scatter(x=x_segment, y=y_segment, mode="lines",
    ...
    for i, s in enumerate(SYMBOL_MASTER, start=1):
        ...
        if ps_dict is None:
            rows.append({
                ...
                "Status": "DATA MISSING", "Ratio": "-", "Above 100": "-",
                "Above 200": "-", "Trend": "-", "RS 21": "-", "RS 63": "-",
                "RS 126": "-", "RS 252": "-"
            })
            continue
        ...
        if r_dict is None:
            rows.append({
                "SL No.": i, "Symbol": s["name"], "Industry": s["industry"],
                "Status": "NO RATIO DATA", "Ratio": "-", "Above 100": "-",
                "Above 200": "-", "Trend": "-", "RS 21": "-", "RS 63": "-",
                "RS 126": "-", "RS 252": "-"
            })
            continue
        ...
        rows.append({
            "SL No.": i, "Symbol": s["name"], "Industry": s["industry"],
            "Status": "OK", "Ratio": float(ratio_val), "Above 100": above_100,
            "Above 200": above_200, "Trend": trend, "RS 21": rs21_val,
            "RS 63": rs63_val, "RS 126": rs126_val, "RS 252": rs252_val
        })
